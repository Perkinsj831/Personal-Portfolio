export const Resume = () => {
    return (
        <div className="resume" style={{ textAlign: 'center' }}>
            ...
            <div>
                <h3>Capstone Project | Developer | March/2024</h3>
            ...
            <div>
                ...
                <p>Efficiently managed product storage within the warehouse, ensuring timely put-away of items in adherence to strict schedules. Demonstrated a high degree of autonomy in executing job duties, requiring minimal supervision and no direct orders from management. Tracked and located long-standing inventory items, coordinating with management to update put-away status and optimize warehouse space utilization.</p>
            </div>
            <div>
                <h3>Assistant General Manager | PharmaCann | April/2018 - July/2022</h3>
                <p>Spearheaded the launch of an online ordering system, enhancing customer access and streamlining sales processes. Played a pivotal role in the opening of four new locations, contributing to significant growth and market expansion. Managed a team of over fifty employees, ensuring optimal staffing levels and operational efficiency.</p>
            </div>
            <div>
                <h3>Store Manager | American Mattress | April/2015 - April/2018</h3>
                <p>Led sales and operational strategies across multiple store locations, consistently surpassing sales targets. Trained and mentored new employees, fostering a culture of excellence and continuous improvement.</p>
            </div>
